...
<div class="section-label">DADOS CLIMA & SOLAR · TEMPO REAL</div>
<div class="grid g-4">
  <div class="card">
    <div class="card-head"><span class="card-title"><i class="fa-solid fa-temperature-high"></i> Sensação Térmica</span></div>
    <div class="kpi-value" id="dashTempNote">—</div>
  </div>
  <div class="card">
    <div class="card-head"><span class="card-title"><i class="fa-solid fa-sun"></i> Nascer do Sol</span></div>
    <div class="kpi-value" id="dashSunrise">—</div>
  </div>
  <div class="card">
    <div class="card-head"><span class="card-title"><i class="fa-solid fa-moon"></i> Pôr do Sol</span></div>
    <div class="kpi-value" id="dashSunset">—</div>
  </div>
  <div class="card">
    <div class="card-head"><span class="card-title"><i class="fa-solid fa-cloud"></i> Nebulosidade</span></div>
    <div class="kpi-value" id="dashCloudCover">— %</div>
  </div>
</div>
`;
...
<div class="card">
  ...
  <div class="map-layers">
    ...
    <span class="chip-toggle" data-layer="hydro"><i class="fa-solid fa-water"></i> Rio & Vazão</span>
    <span class="chip-toggle" data-layer="meteo"><i class="fa-solid fa-temperature-high"></i> Meteorologia</span>
  </div>
</div>
`;
